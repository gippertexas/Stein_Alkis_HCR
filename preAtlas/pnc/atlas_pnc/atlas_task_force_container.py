...
class AtlasTaskForceContainer(TaskForceContainer):
    def __init__(self, robot):
        ...
        # Rfoot Pos Task
        self._rfoot_pos_task = BasicTask(robot, "LINK_XYZ", 3, "r_sole", # originally 3
                                         PnCConfig.SAVE_DATA)
        ...
        # Lfoot Pos Task
        self._lfoot_pos_task = BasicTask(robot, "LINK_XYZ", 3, "l_sole", # originally 3
                                         PnCConfig.SAVE_DATA)
        ...
        # Rfoot Ori Task
        self._rfoot_ori_task = BasicTask(robot, "LINK_ORI", 3, "r_sole", # originally 3
                                         PnCConfig.SAVE_DATA)
        ...
        # Lfoot Ori Task
        self._lfoot_ori_task = BasicTask(robot, "LINK_ORI", 3, "l_sole", # originally 3
                                         PnCConfig.SAVE_DATA)
